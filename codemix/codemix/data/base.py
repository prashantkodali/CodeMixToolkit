...
class CodeMixDataset:
    ...
    def get_data(self) -> Union[Dataset, DatasetDict, pd.DataFrame]:
        """Get the loaded data"""
        return self.data
...
class HFDatasetsReader(CodeMixDataset):
    ...
    def __init__(self, dataset_name: str, dataset_config: Optional[str] = None, 
                 split: Optional[str] = None, dataset_info: Optional[DatasetInfo] = None, **kwargs):
        """
